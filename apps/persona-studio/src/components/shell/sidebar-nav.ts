...
export const SIDEBAR_SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/briefs', label: 'Workspace', key: 'create-workspace', hint: 'brief → script → video' },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/research/trends', label: 'Trends', key: 'disc-trends', hint: 'audio · hooks · formats' },
      ...
      { href: '/measure', label: 'Analytics', key: 'disc-measure', hint: 'your Xn + attribution' },
