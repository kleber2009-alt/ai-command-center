...
const RU_DICT: Record<string, string> = {
  ...
  'spy & account analysis': 'шпион и разбор аккаунта',
  'post-level content search': 'поиск контента по постам',
  'niche-based viral hunt': 'поиск виральных по нише',
  'audio · hooks · formats': 'аудио · хуки · форматы',
  'your Xn + attribution': 'твой Xn + источник',
