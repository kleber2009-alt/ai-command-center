    ...
    <div className="animate-slide-in space-y-6">
      ...
      {!historyConfigured && (
        <p className="px-1 text-[12px] text-apple-faint">
          История транскриптов выключена — задайте <code className="rounded bg-apple-bg-soft px-1 py-0.5 text-apple-muted">DATABASE_URL</code> и накатите <code className="rounded bg-apple-bg-soft px-1 py-0.5 text-apple-muted">db/init.sql</code> на Postgres (внутри docker compose это происходит автоматически).
        </p>
      )}
    </div>
  )
