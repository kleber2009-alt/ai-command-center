    ...
    <div className="animate-slide-in space-y-6">
      ...
      {!historyConfigured && (
        <p className="px-1 text-[12px] text-apple-faint">
          История транскриптов выключена — добавьте <code className="rounded bg-apple-bg-soft px-1 py-0.5 text-apple-muted">DATABASE_URL</code> и выполните миграцию <code className="rounded bg-apple-bg-soft px-1 py-0.5 text-apple-muted">supabase/migrations/001_transcripts.sql</code> в вашем Postgres.
        </p>
      )}
    </div>
  )
